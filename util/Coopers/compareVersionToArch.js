...
const similarity = require('../cosine-similarity.js');
 ...
 * Function creates and assigns a spine index field for each JSON object.
 * @param version1
 * @param version2
 * @returns
 */
...
//compare 2 to 1
         let modifiedVersions =  generateIndex(version1, version2)
            // compare 1 to 2
            modifiedVersions = generateIndex(modifiedVersions[0], modifiedVersions[1])

   //
   // const editedVersion1 = removeBlankSpineIndexes(version1);
   // const editedVersion2 = removeBlankSpineIndexes(version2);

    return [modifiedVersions[0], modifiedVersions[1]];

};

        function generateIndex(version1, version2) {
